...
public class SysUserController extends AbstractController {
    ...
    public R userInfo(@RequestHeader("token") String token, @PathVariable("userId") Long userId){
        R verifyResult = verifyToken(token);
        if(verifyResult != null) return verifyResult;
    ...
    public R save(@RequestHeader("token") String token, @RequestBody SysUserEntity user){
        R verifyResult = verifyToken(token);
        if(verifyResult != null) return verifyResult;
    ...
    @PostMapping("/update")
    @RequiresPermissions("sys:user:update")
    public R update(@RequestHeader("token") String token, @RequestBody SysUserEntity user){
        R verifyResult = verifyToken(token);
        if(verifyResult != null) return verifyResult;
    ...
    public R delete(@RequestHeader("token") String token, @RequestBody Long[] userIds){
        R verifyResult = verifyToken(token);
        if(verifyResult != null) return verifyResult;
